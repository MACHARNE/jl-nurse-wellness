  ...
  return (
    <section className="relative flex min-h-[90vh] items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(246,243,239,0.22),rgba(246,243,239,0.18))]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(201,161,74,0.18),_transparent_45%)]" />
      </div>
      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 py-20 sm:px-6">
        ...
        >
          <motion.h1
            ...
            style={{ textShadow: '0 4px 12px rgba(246, 243, 239, 0.45)' }}
          >
